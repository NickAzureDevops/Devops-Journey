...
- az keyvault secret set --vault-name "devopsjourneytest-kvtest" --name "AIKEY" --value 3c8fc445-de4c-4c38-a758-f4c85f0b2797 (Replace the value by AIKEY to the Instrumentation Key)
