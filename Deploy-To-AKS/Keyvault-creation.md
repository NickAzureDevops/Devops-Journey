...
- az keyvault secret set --vault-name "devopsjourneytest-kvtest" --name "AIKEY" --value 669122d4-6e7a-4c44-a556-0efd0d1a19fe (Replace the value by AIKEY to the Instrumentation Key)
